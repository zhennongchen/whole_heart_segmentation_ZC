...
def init_distributed_mode(args):
    ...
    print ("Wolrd size " , args.world_size)
    ...
    torch.distributed.init_process_group(backend=args.dist_backend, init_method='tcp://127.0.0.1:23456',
        ...
        if args.resume.startswith('https'):
            ...
            for i in model_without_ddp.state_dict():
                ...
                if i not in checkpoint:
                    checkpoint[i] = model_without_ddp.state_dict()[i]
